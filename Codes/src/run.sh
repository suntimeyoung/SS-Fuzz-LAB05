...
clang++-12 -g -S -emit-llvm ../../testcases/shared_array_example.cpp -o ../bin/shared_array_example.ll
...
../bin/modify ../bin/shared_array_example.ll ../bin/shared_array_example_ed.ll
...
clang++-12 -c ../bin/shared_array_example_ed.ll -o ../bin/shared_array_example_ed.o
...
clang++-12 ../bin/shared_array_example_ed.o ../bin/func.o -o ../bin/shared_array_example_ed
...
echo "======= Testing file of shared_array_example_ed ======="
rm ../log/*
echo "1" | ../bin/shared_array_example_ed
../bin/check_lock
echo "-----------------------------------------------------"
