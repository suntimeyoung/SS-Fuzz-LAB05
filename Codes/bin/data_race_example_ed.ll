; ModuleID = '../bin/data_race_example.ll'
...
6:                                                ; preds = %16, %1
  ...
  call void @memoryLoadHook(i8* %7)
  %8 = load i32, i32* %3, align 4
  call void @memoryLoadHook(i8* bitcast (i32* @run_time to i8*))
  %9 = load i32, i32* @run_time, align 4
  %10 = icmp slt i32 %8, %9
  br i1 %10, label %11, label %21

11:                                               ; preds = %6
  call void @lockAddHook(i8* bitcast (%union.pthread_mutex_t* @mutex to i8*))
  %12 = call i32 @pthread_mutex_lock(%union.pthread_mutex_t* @mutex) #3
  call void @memoryLoadHook(i8* bitcast (i32* @counter to i8*))
  %13 = load i32, i32* @counter, align 4
  %14 = add nsw i32 %13, 1
  call void @memoryStoreHook(i8* bitcast (i32* @counter to i8*))
  store i32 %14, i32* @counter, align 4
  call void @lockRemoveHook(i8* bitcast (%union.pthread_mutex_t* @mutex to i8*))
  %15 = call i32 @pthread_mutex_unlock(%union.pthread_mutex_t* @mutex) #3
  br label %16

16:                                               ; preds = %11
  %17 = bitcast i32* %3 to i8*
  call void @memoryLoadHook(i8* %17)
  %18 = load i32, i32* %3, align 4
  %19 = add nsw i32 %18, 1
  %20 = bitcast i32* %3 to i8*
  call void @memoryStoreHook(i8* %20)
...
define dso_local i32 @main() #5 {
  ...
  %6 = call i32 @pthread_create(i64* %2, %union.pthread_attr_t* null, i8* (i8*)* @_Z9incrementPv, i8* null) #3
  %7 = call i32 @pthread_create(i64* %3, %union.pthread_attr_t* null, i8* (i8*)* @_Z9decrementPv, i8* null) #3
  ...
  %14 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str, i64 0, i64 0))
  call void @memoryLoadHook(i8* bitcast (i32* @counter to i8*))
