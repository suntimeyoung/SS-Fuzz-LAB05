; ModuleID = '../../testcases/atomicity_violation_example.cpp'
...
5:                                                ; preds = %16, %1
  ...
  %7 = load i32, i32* @run_time, align 4
  %8 = icmp slt i32 %6, %7
  br i1 %8, label %9, label %19

9:                                                ; preds = %5
  %10 = call i32 @pthread_mutex_lock(%union.pthread_mutex_t* @mutex) #3
...
define dso_local i32 @main() #5 {
  ...
  %5 = call i32 @pthread_create(i64* %2, %union.pthread_attr_t* null, i8* (i8*)* @_Z3addPv, i8* null) #3
  %6 = call i32 @pthread_create(i64* %3, %union.pthread_attr_t* null, i8* (i8*)* @_Z8subtractPv, i8* null) #3
  %7 = load i64, i64* %2, align 8
  %8 = call i32 @pthread_join(i64 %7, i8** null)
  %9 = load i64, i64* %3, align 8
  %10 = call i32 @pthread_join(i64 %9, i8** null)
  %11 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0))
