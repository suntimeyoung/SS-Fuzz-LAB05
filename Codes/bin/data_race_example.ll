; ModuleID = '../../testcases/data_race_example.cpp'
source_filename = "../../testcases/data_race_example.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_data_race_example.cpp, i8* null }]
...
define dso_local i8* @_Z9incrementPv(i8* %0) #4 {
  %2 = alloca i8*, align 8
...
4:                                                ; preds = %13, %1
  ...
  %6 = load i32, i32* @run_time, align 4
  %7 = icmp slt i32 %5, %6
  br i1 %7, label %8, label %16

8:                                                ; preds = %4
  %9 = call i32 @pthread_mutex_lock(%union.pthread_mutex_t* @mutex) #3
  %10 = load i32, i32* @counter, align 4
  %11 = add nsw i32 %10, 1
  store i32 %11, i32* @counter, align 4
  %12 = call i32 @pthread_mutex_unlock(%union.pthread_mutex_t* @mutex) #3
  br label %13
...
; Function Attrs: noinline nounwind optnone uwtable mustprogress
define dso_local i8* @_Z9decrementPv(i8* %0) #4 {
  %2 = alloca i8*, align 8
  %3 = alloca i32, align 4
  store i8* %0, i8** %2, align 8
  store i32 0, i32* %3, align 4
...
define dso_local i32 @main() #5 {
  ...
  %4 = call nonnull align 8 dereferenceable(16) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* nonnull dereferenceable(16) @_ZSt3cin, i32* nonnull align 4 dereferenceable(4) @run_time)
  %5 = call i32 @pthread_create(i64* %2, %union.pthread_attr_t* null, i8* (i8*)* @_Z9incrementPv, i8* null) #3
  %6 = call i32 @pthread_create(i64* %3, %union.pthread_attr_t* null, i8* (i8*)* @_Z9decrementPv, i8* null) #3
  %7 = load i64, i64* %2, align 8
  %8 = call i32 @pthread_join(i64 %7, i8** null)
  %9 = load i64, i64* %3, align 8
  %10 = call i32 @pthread_join(i64 %9, i8** null)
  %11 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str, i64 0, i64 0))
  %12 = load i32, i32* @counter, align 4
  %13 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* nonnull dereferenceable(8) %11, i32 %12)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_data_race_example.cpp() #0 section ".text.startup" {
